...
def main():
    ...
    parse.add_argument('-f', '--folder', dest='folder', help='folder with images of (*.jpg, *.jpeg, *.png)', default='.')
    ...
    parse.add_argument('-r', '--random', action='store_true', dest='random', help='randomize images')
    parse.add_argument('-s', '--sort', action='store_true', dest='sort', help='sort images')
